          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '12px', justifyContent: 'center' }}>
            <div className="glass-panel text-center" style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '12px 8px' }}>
               ...
               <div className="flex items-center justify-center gap-2">
                 <button type="button" onClick={() => setFormData(p => ({...p, currentQuantity: Math.max(0, (p.currentQuantity || 0) - 1)}))} style={{ width: '32px', height: '32px', fontSize: '1.2rem', borderRadius: '50%', border: 'none', background: '#e74c3c', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                   <Minus size={18} />
                 </button>
                 ...
                 <button type="button" onClick={() => setFormData(p => ({...p, currentQuantity: (p.currentQuantity || 0) + 1}))} style={{ width: '32px', height: '32px', fontSize: '1.2rem', borderRadius: '50%', border: 'none', background: 'var(--rakbuy-green)', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                   <Plus size={18} />
                 </button>
               </div>
            </div>
            ...
            <div className="glass-panel text-center" style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '12px 8px' }}>
               ...
               <div className="flex items-center justify-center gap-2">
                 <button type="button" onClick={() => setFormData(p => ({...p, targetQuantity: Math.max(0, (p.targetQuantity || 0) - 1)}))} style={{ width: '32px', height: '32px', fontSize: '1.2rem', borderRadius: '50%', border: 'none', background: '#e74c3c', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                   <Minus size={18} />
                 </button>
